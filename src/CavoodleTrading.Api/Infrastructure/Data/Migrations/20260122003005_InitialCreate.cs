        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CavoodleKarma = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FloofFactor = table.Column<int>(type: "integer", nullable: false),
                    SassRating = table.Column<int>(type: "integer", nullable: false),
                    CustomBio = table.Column<string>(type: "text", nullable: true),
                    QuizAnswersJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonalityProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonalityProfiles_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonalityProfiles_ListingId",
